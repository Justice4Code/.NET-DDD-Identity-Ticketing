			...
			columns: [
				{
					...
					template: function (data, i) {
						return '\
						<a href="javascript:;" class="btn btn-sm btn-clean btn-icon btn-icon-md Category-edit" title="ویرایش" data-id="'+ data.Id + '">\
							<i class="la la-edit"></i>\
						</a>\
						<a href="javascript:;" class="btn btn-sm btn-clean btn-icon btn-icon-md Category-delete" title="حذف" data-id="'+ data.Id + '">\
...
jQuery(document).ready(function () {
	...
	$(document).on('click', '.Category-delete', function () {
		...
		Swal.fire({
			...
			text: "این دسته بندی بصورت کامل حذف می شود",
			icon: 'warning',
